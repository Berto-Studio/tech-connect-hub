...
const portfolioItems = [
  { image: portfolio1, title: "Corporate Server Room", category: "Enterprise", desc: "Full structured cabling & rack installation for a 200-employee office in Accra." },
  { image: portfolio2, title: "CCTV Security System", category: "Surveillance", desc: "32-camera IP surveillance system for a shopping complex in Kumasi." },
  { image: portfolio3, title: "Hotel WiFi Network", category: "Hospitality", desc: "Seamless WiFi coverage across 150 rooms for a 4-star hotel in Takoradi." },
];
...
const Index = () => (
  <>
    ...
    {/* Featured Services — no price, learn more button */}
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <p className="text-muted-foreground">Professional networking services tailored to your needs.</p>
          </div>
          <Button variant="ghost" asChild>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.slice(0, 3).map((s) => {
            ...
            return (
              <motion.div key={s.id} {...fadeUp} className="p-6 rounded-xl bg-card border hover:border-primary/40 hover:shadow-md transition-all group">
    ...
    <section className="py-24 bg-card">
      <div className="container mx-auto px-4">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground max-w-md mx-auto">A glimpse into some of our completed installations across Ghana.</p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {portfolioItems.map((item, i) => (
            <motion.div key={item.title} {...fadeUp} transition={{ duration: 0.5, delay: i * 0.1 }}
              className="rounded-xl overflow-hidden border bg-background group">
              <div className="relative overflow-hidden">
                <img src={item.image} alt={item.title} loading="lazy" width={640} height={512}
